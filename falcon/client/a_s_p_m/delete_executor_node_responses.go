...
type DeleteExecutorNodeOK struct {
	...
	Payload *DeleteExecutorNodeOKBody
}
...
func (o *DeleteExecutorNodeOK) Error() string {
	return fmt.Sprintf("[DELETE /aspm-api-gateway/api/v1/executor_nodes/{ID}][%d] deleteExecutorNodeOK  %+v", 200, o.Payload)
}
...
func (o *DeleteExecutorNodeOK) GetPayload() *DeleteExecutorNodeOKBody {
	return o.Payload
}
...
func (o *DeleteExecutorNodeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(DeleteExecutorNodeOKBody)
...
/*
DeleteExecutorNodeOKBody delete executor node o k body
swagger:model DeleteExecutorNodeOKBody
*/
type DeleteExecutorNodeOKBody struct {
...
// Validate validates this delete executor node o k body
func (o *DeleteExecutorNodeOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteExecutorNodeOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("deleteExecutorNodeOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("deleteExecutorNodeOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *DeleteExecutorNodeOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("deleteExecutorNodeOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("deleteExecutorNodeOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this delete executor node o k body based on the context it is used
func (o *DeleteExecutorNodeOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteExecutorNodeOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *DeleteExecutorNodeOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *DeleteExecutorNodeOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *DeleteExecutorNodeOKBody) UnmarshalBinary(b []byte) error {
	var res DeleteExecutorNodeOKBody
