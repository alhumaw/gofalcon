...
func (o *DeleteGroupId09OK) Error() string {
	return fmt.Sprintf("[DELETE /aspm-api-gateway/api/v1/group/{ID}][%d] deleteGroupId09OK  %+v", 200, o.Payload)
}
...
func (o *DeleteGroupId09OK) GetPayload() *DeleteGroupId09OKBody {
	return o.Payload
}
...
func (o *DeleteGroupId09OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(DeleteGroupId09OKBody)
...
/*
DeleteGroupId09OKBody delete group id09 o k body
swagger:model DeleteGroupId09OKBody
*/
type DeleteGroupId09OKBody struct {
...
// Validate validates this delete group id09 o k body
func (o *DeleteGroupId09OKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteGroupId09OKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("deleteGroupId09OK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("deleteGroupId09OK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *DeleteGroupId09OKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("deleteGroupId09OK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("deleteGroupId09OK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this delete group id09 o k body based on the context it is used
func (o *DeleteGroupId09OKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteGroupId09OKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *DeleteGroupId09OKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *DeleteGroupId09OKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *DeleteGroupId09OKBody) UnmarshalBinary(b []byte) error {
	var res DeleteGroupId09OKBody
