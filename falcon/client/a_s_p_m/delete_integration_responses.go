...
func (o *DeleteIntegrationOK) Error() string {
	return fmt.Sprintf("[DELETE /aspm-api-gateway/api/v1/integrations/{ID}][%d] deleteIntegrationOK  %+v", 200, o.Payload)
}
...
/*
DeleteIntegrationOKBody delete integration o k body
...
func (o *DeleteIntegrationOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("deleteIntegrationOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("deleteIntegrationOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *DeleteIntegrationOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("deleteIntegrationOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("deleteIntegrationOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this delete integration o k body based on the context it is used
func (o *DeleteIntegrationOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteIntegrationOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *DeleteIntegrationOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
