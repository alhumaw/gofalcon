...
type DeleteIntegrationTaskOK struct {
	...
	Payload *DeleteIntegrationTaskOKBody
}
...
func (o *DeleteIntegrationTaskOK) Error() string {
	return fmt.Sprintf("[DELETE /aspm-api-gateway/api/v1/integration_tasks/{ID}][%d] deleteIntegrationTaskOK  %+v", 200, o.Payload)
}
...
func (o *DeleteIntegrationTaskOK) GetPayload() *DeleteIntegrationTaskOKBody {
	return o.Payload
}
...
func (o *DeleteIntegrationTaskOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(DeleteIntegrationTaskOKBody)
...
/*
DeleteIntegrationTaskOKBody delete integration task o k body
swagger:model DeleteIntegrationTaskOKBody
*/
type DeleteIntegrationTaskOKBody struct {
...
// Validate validates this delete integration task o k body
func (o *DeleteIntegrationTaskOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteIntegrationTaskOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("deleteIntegrationTaskOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("deleteIntegrationTaskOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *DeleteIntegrationTaskOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("deleteIntegrationTaskOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("deleteIntegrationTaskOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this delete integration task o k body based on the context it is used
func (o *DeleteIntegrationTaskOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteIntegrationTaskOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *DeleteIntegrationTaskOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *DeleteIntegrationTaskOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *DeleteIntegrationTaskOKBody) UnmarshalBinary(b []byte) error {
	var res DeleteIntegrationTaskOKBody
