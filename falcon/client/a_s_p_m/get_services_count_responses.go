...
type GetServicesCountOK struct {
	...
	Payload *GetServicesCountOKBody
}
...
func (o *GetServicesCountOK) Error() string {
	return fmt.Sprintf("[POST /aspm-api-gateway/api/v1/services/count][%d] getServicesCountOK  %+v", 200, o.Payload)
}
...
func (o *GetServicesCountOK) GetPayload() *GetServicesCountOKBody {
	return o.Payload
}
...
func (o *GetServicesCountOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(GetServicesCountOKBody)
...
/*
GetServicesCountOKBody get services count o k body
swagger:model GetServicesCountOKBody
*/
type GetServicesCountOKBody struct {
...
// Validate validates this get services count o k body
func (o *GetServicesCountOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetServicesCountOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("getServicesCountOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("getServicesCountOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *GetServicesCountOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getServicesCountOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getServicesCountOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this get services count o k body based on the context it is used
func (o *GetServicesCountOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *GetServicesCountOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *GetServicesCountOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *GetServicesCountOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *GetServicesCountOKBody) UnmarshalBinary(b []byte) error {
	var res GetServicesCountOKBody
