...
type SetCloudSecurityIntegrationStateOK struct {
	...
	Payload *SetCloudSecurityIntegrationStateOKBody
}
...
func (o *SetCloudSecurityIntegrationStateOK) Error() string {
	return fmt.Sprintf("[POST /aspm-api-gateway/api/v1/cloud_security_config][%d] setCloudSecurityIntegrationStateOK  %+v", 200, o.Payload)
}
...
func (o *SetCloudSecurityIntegrationStateOK) GetPayload() *SetCloudSecurityIntegrationStateOKBody {
	return o.Payload
}
...
func (o *SetCloudSecurityIntegrationStateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(SetCloudSecurityIntegrationStateOKBody)
...
/*
SetCloudSecurityIntegrationStateOKBody set cloud security integration state o k body
swagger:model SetCloudSecurityIntegrationStateOKBody
*/
type SetCloudSecurityIntegrationStateOKBody struct {
...
// Validate validates this set cloud security integration state o k body
func (o *SetCloudSecurityIntegrationStateOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *SetCloudSecurityIntegrationStateOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("setCloudSecurityIntegrationStateOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("setCloudSecurityIntegrationStateOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *SetCloudSecurityIntegrationStateOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("setCloudSecurityIntegrationStateOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("setCloudSecurityIntegrationStateOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this set cloud security integration state o k body based on the context it is used
func (o *SetCloudSecurityIntegrationStateOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *SetCloudSecurityIntegrationStateOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *SetCloudSecurityIntegrationStateOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *SetCloudSecurityIntegrationStateOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *SetCloudSecurityIntegrationStateOKBody) UnmarshalBinary(b []byte) error {
	var res SetCloudSecurityIntegrationStateOKBody
