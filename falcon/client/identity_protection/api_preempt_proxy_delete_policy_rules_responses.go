...
type APIPreemptProxyDeletePolicyRulesOK struct {
	...
	Payload *APIPreemptProxyDeletePolicyRulesOKBody
}
...
func (o *APIPreemptProxyDeletePolicyRulesOK) Error() string {
	return fmt.Sprintf("[DELETE /identity-protection/entities/policy-rules/v1][%d] apiPreemptProxyDeletePolicyRulesOK  %+v", 200, o.Payload)
}
...
func (o *APIPreemptProxyDeletePolicyRulesOK) GetPayload() *APIPreemptProxyDeletePolicyRulesOKBody {
	return o.Payload
}
...
func (o *APIPreemptProxyDeletePolicyRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(APIPreemptProxyDeletePolicyRulesOKBody)
...
/*
APIPreemptProxyDeletePolicyRulesOKBody API preempt proxy delete policy rules o k body
swagger:model APIPreemptProxyDeletePolicyRulesOKBody
*/
type APIPreemptProxyDeletePolicyRulesOKBody struct {
...
// Validate validates this API preempt proxy delete policy rules o k body
func (o *APIPreemptProxyDeletePolicyRulesOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *APIPreemptProxyDeletePolicyRulesOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("apiPreemptProxyDeletePolicyRulesOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("apiPreemptProxyDeletePolicyRulesOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *APIPreemptProxyDeletePolicyRulesOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("apiPreemptProxyDeletePolicyRulesOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("apiPreemptProxyDeletePolicyRulesOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this API preempt proxy delete policy rules o k body based on the context it is used
func (o *APIPreemptProxyDeletePolicyRulesOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *APIPreemptProxyDeletePolicyRulesOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *APIPreemptProxyDeletePolicyRulesOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *APIPreemptProxyDeletePolicyRulesOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *APIPreemptProxyDeletePolicyRulesOKBody) UnmarshalBinary(b []byte) error {
	var res APIPreemptProxyDeletePolicyRulesOKBody
