...
type APIPreemptProxyGetPolicyRulesOK struct {
	...
	Payload *APIPreemptProxyGetPolicyRulesOKBody
}
...
func (o *APIPreemptProxyGetPolicyRulesOK) Error() string {
	return fmt.Sprintf("[GET /identity-protection/entities/policy-rules/v1][%d] apiPreemptProxyGetPolicyRulesOK  %+v", 200, o.Payload)
}
...
func (o *APIPreemptProxyGetPolicyRulesOK) GetPayload() *APIPreemptProxyGetPolicyRulesOKBody {
	return o.Payload
}
...
func (o *APIPreemptProxyGetPolicyRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(APIPreemptProxyGetPolicyRulesOKBody)
...
/*
APIPreemptProxyGetPolicyRulesOKBody API preempt proxy get policy rules o k body
swagger:model APIPreemptProxyGetPolicyRulesOKBody
*/
type APIPreemptProxyGetPolicyRulesOKBody struct {
...
// Validate validates this API preempt proxy get policy rules o k body
func (o *APIPreemptProxyGetPolicyRulesOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *APIPreemptProxyGetPolicyRulesOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("apiPreemptProxyGetPolicyRulesOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("apiPreemptProxyGetPolicyRulesOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *APIPreemptProxyGetPolicyRulesOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("apiPreemptProxyGetPolicyRulesOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("apiPreemptProxyGetPolicyRulesOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this API preempt proxy get policy rules o k body based on the context it is used
func (o *APIPreemptProxyGetPolicyRulesOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *APIPreemptProxyGetPolicyRulesOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *APIPreemptProxyGetPolicyRulesOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *APIPreemptProxyGetPolicyRulesOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *APIPreemptProxyGetPolicyRulesOKBody) UnmarshalBinary(b []byte) error {
	var res APIPreemptProxyGetPolicyRulesOKBody
