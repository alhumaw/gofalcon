...
type APIPreemptProxyPostGraphqlOK struct {
	...
	Payload *APIPreemptProxyPostGraphqlOKBody
}
...
func (o *APIPreemptProxyPostGraphqlOK) GetPayload() *APIPreemptProxyPostGraphqlOKBody {
	return o.Payload
}
...
func (o *APIPreemptProxyPostGraphqlOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(APIPreemptProxyPostGraphqlOKBody)
...
/*
APIPreemptProxyPostGraphqlOKBody API preempt proxy post graphql o k body
swagger:model APIPreemptProxyPostGraphqlOKBody
*/
type APIPreemptProxyPostGraphqlOKBody struct {
...
// Validate validates this API preempt proxy post graphql o k body
func (o *APIPreemptProxyPostGraphqlOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *APIPreemptProxyPostGraphqlOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("apiPreemptProxyPostGraphqlOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("apiPreemptProxyPostGraphqlOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *APIPreemptProxyPostGraphqlOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("apiPreemptProxyPostGraphqlOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("apiPreemptProxyPostGraphqlOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this API preempt proxy post graphql o k body based on the context it is used
func (o *APIPreemptProxyPostGraphqlOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *APIPreemptProxyPostGraphqlOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *APIPreemptProxyPostGraphqlOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *APIPreemptProxyPostGraphqlOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *APIPreemptProxyPostGraphqlOKBody) UnmarshalBinary(b []byte) error {
	var res APIPreemptProxyPostGraphqlOKBody
