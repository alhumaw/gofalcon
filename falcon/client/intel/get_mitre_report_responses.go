...
func (o *GetMitreReportOK) GetPayload() *GetMitreReportOKBody {
	return o.Payload
}
...
func (o *GetMitreReportOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(GetMitreReportOKBody)
...
/*
GetMitreReportOKBody get mitre report o k body
swagger:model GetMitreReportOKBody
*/
type GetMitreReportOKBody struct {
...
// Validate validates this get mitre report o k body
func (o *GetMitreReportOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetMitreReportOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("getMitreReportOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("getMitreReportOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *GetMitreReportOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("getMitreReportOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("getMitreReportOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this get mitre report o k body based on the context it is used
func (o *GetMitreReportOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *GetMitreReportOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *GetMitreReportOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *GetMitreReportOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *GetMitreReportOKBody) UnmarshalBinary(b []byte) error {
	var res GetMitreReportOKBody
