...
type PostMitreAttacksOK struct {
	...
	Payload *PostMitreAttacksOKBody
}
...
func (o *PostMitreAttacksOK) Error() string {
	return fmt.Sprintf("[POST /intel/entities/mitre/v1][%d] postMitreAttacksOK  %+v", 200, o.Payload)
}
...
func (o *PostMitreAttacksOK) GetPayload() *PostMitreAttacksOKBody {
	return o.Payload
}
...
func (o *PostMitreAttacksOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(PostMitreAttacksOKBody)
...
/*
PostMitreAttacksOKBody post mitre attacks o k body
swagger:model PostMitreAttacksOKBody
*/
type PostMitreAttacksOKBody struct {
...
// Validate validates this post mitre attacks o k body
func (o *PostMitreAttacksOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PostMitreAttacksOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("postMitreAttacksOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("postMitreAttacksOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *PostMitreAttacksOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("postMitreAttacksOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("postMitreAttacksOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this post mitre attacks o k body based on the context it is used
func (o *PostMitreAttacksOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *PostMitreAttacksOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *PostMitreAttacksOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *PostMitreAttacksOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *PostMitreAttacksOKBody) UnmarshalBinary(b []byte) error {
	var res PostMitreAttacksOKBody
