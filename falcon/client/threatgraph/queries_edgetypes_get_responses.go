...
type QueriesEdgetypesGetOK struct {
	...
	Payload *QueriesEdgetypesGetOKBody
}
...
func (o *QueriesEdgetypesGetOK) Error() string {
	return fmt.Sprintf("[GET /threatgraph/queries/edge-types/v1][%d] queriesEdgetypesGetOK  %+v", 200, o.Payload)
}
...
func (o *QueriesEdgetypesGetOK) GetPayload() *QueriesEdgetypesGetOKBody {
	return o.Payload
}
...
func (o *QueriesEdgetypesGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(QueriesEdgetypesGetOKBody)
...
/*
QueriesEdgetypesGetOKBody queries edgetypes get o k body
swagger:model QueriesEdgetypesGetOKBody
*/
type QueriesEdgetypesGetOKBody struct {
...
// Validate validates this queries edgetypes get o k body
func (o *QueriesEdgetypesGetOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *QueriesEdgetypesGetOKBody) validateErrors(formats strfmt.Registry) error {
		...
		if o.Errors[i] != nil {
			if err := o.Errors[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("queriesEdgetypesGetOK" + "." + "errors" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("queriesEdgetypesGetOK" + "." + "errors" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *QueriesEdgetypesGetOKBody) validateMeta(formats strfmt.Registry) error {
	...
	if o.Meta != nil {
		if err := o.Meta.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("queriesEdgetypesGetOK" + "." + "meta")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("queriesEdgetypesGetOK" + "." + "meta")
			}
			return err
		}
	}
...
// ContextValidate validate this queries edgetypes get o k body based on the context it is used
func (o *QueriesEdgetypesGetOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *QueriesEdgetypesGetOKBody) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (o *QueriesEdgetypesGetOKBody) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (o *QueriesEdgetypesGetOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *QueriesEdgetypesGetOKBody) UnmarshalBinary(b []byte) error {
	var res QueriesEdgetypesGetOKBody
